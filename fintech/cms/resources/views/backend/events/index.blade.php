...
<div class="app-title">
    <div>
        <h1><i class="fa fa-home"></i>Events Page Settings</h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.events.get') }}">Events</a></li>
    </ul>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-md-12">
                    ...
                    <form class="row" action="{{ route('admin.events.post') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <tbody id="appendFeatured">
                                    ...
                                    @foreach($events as $feat)
                                        <tr class="featuredRow">
                                            ...
                                            <td>
                                              <input type="text" name="title[{{$i}}]" id="title" class="form-control" value="{{$feat->title}}">
                                            </td>
                                            <td>
...
<script>
    ...
    function addMoreFeatured(countRows){
        ...
        let titleBox = `<input type="text" name="title[${countRows}]" class="form-control" >`;

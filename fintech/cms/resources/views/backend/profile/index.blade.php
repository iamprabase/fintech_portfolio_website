...
<div class="row user">
    <div class="col-md-12">
        <div class="profile">
        <div class="info" style="padding: 100px 60px;">
    ...
    <div class="col-md-12">
        ...
        <div class="tab-pane active" id="user-settings">
            ...
            <form action="{{ route('admin.profile.post', [auth()->id()]) }}" method="POST">
                @csrf
                <div class="row mb-4">
                    <div class="col-md-8 mb-4">
                        <label> Name</label>
                        <input class="form-control" name="name" type="text" placeholder="Enter Name" value="{{ $name }}" autofocus required>
                    </div>
                    <!-- <div class="col-md-4">
...
<script>
    @error('name')
        showNotification("Error:- ", "{{$message}}", 'fa fa-remove', 'warning');
    @endif
